      ...
      <ul className="mt-10 grid grid-cols-2 gap-x-5 gap-y-8 sm:grid-cols-3 lg:grid-cols-2">
        {images.map((image, index) => (
          <li key={image.id}>
            ...
            >
              <span className="card-shadow relative block aspect-[4/5] w-full overflow-hidden rounded-sm gold-glow border-[16px] border-gold-border">
                <Image
                  src={image.image_url}
                  alt={image.title}
                  fill
          ...
          >
            ...
            >
              <Image
                ...
                width={900}
                height={1125}
                className="max-h-[80vh] w-auto rounded-sm gold-glow border-[16px] border-gold-border object-contain"
              />
